  ...
  <section>
    ...
    <?php 
      ...
      if(isset($_GET['search'])) {
        ...
        $query = "SELECT dni, firstname, lastname, course, apercibimientos, DATE_FORMAT(date_joined, '%m/%d/%Y') as date_joined, CONCAT(firstname, ' ', lastname) as fullname 
        FROM students WHERE lastname = '$s' OR firstname = '$s' OR lastname = '$s' ORDER BY date_joined DESC LIMIT 5";
    ?>
