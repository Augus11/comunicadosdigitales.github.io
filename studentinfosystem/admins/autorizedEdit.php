            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM autorized WHERE id=$id";
                        ...
                        do {
                            $sql = "UPDATE autorized " . 
                            "SET pname = '$pname', pdni = '$pdni', sdni = '$sdni'" . "WHERE id = $id";
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="autorized.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="pname" value="<?php echo $pname; ?>"></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">DNI de la persona</label>
                                                        <input class="form-control" type="number" style="margin-bottom:15px;" name="pdni" value="<?php echo $pdni; ?>"></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">DNI del alumno</label>
                                                        <input class="form-control" type="number" style="margin-bottom:15px;" name="sdni" value="<?php echo $sdni; ?>"></input>  
                                                    </div>
                                                </p>
