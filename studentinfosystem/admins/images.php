...
//  print_r($filename_separate);
	...
	if(in_array($file_extension,$extension)) {
		...
		$sql = "INSERT INTO images (dni, image_url) values('$dni', '$image')";
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <div style="display:inline; float:left;"> 
                            ...
                            <a href="imageUpload.php" class="btn btn-primary" style="width:150px; margin:10px;">Ver Certificados</a>
                        </div>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <center>
                                        <div class="profile-box box-left">
                                            ...
                                            <center>
                                                <label for="textarea" class="title" style="font-size:15px; margin-bottom:0px; margin-top:20px; font-weight:bold;">Subir un certificado</label>
                                                <p>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Imágen (JPG)</label>
                                                ...
                                                <p>
                                                    ...
                                                    <input  type="submit" name="submit" class="btn btn-success" value="Subir">
