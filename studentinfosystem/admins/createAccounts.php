...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Crear Cuentas - Colegio Preuniversitario Escobar</title>
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="home.php" class="btn btn-primary" style="width: auto; margin:15px; margin-right:5px;">← Volver atras</a>
                            ...
                            <a class="btn btn-primary" href="register.php" style="margin:10px;">Crear cuenta de administrador</a>
                            <a class="btn btn-primary" href="../students/register.php" style="margin:10px;">Crear cuenta de estudiante</a>
                            <a class="btn btn-primary" href="../teachers/register.php" style="margin:10px;">Crear cuenta de coordinador</a>
