...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Cursos - Colegio Preuniversitario Escobar</title>
                                ...
                                <center>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Nombre del curso</label>
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="course"></input>
                                                    </div>
                                                </p>
                                    ...
                                    <?php
                                        if(isset($_POST['submit'])) {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO courses (course) VALUES('".$_POST['course']."')");	
                                    ...
                                    <div class="container my-5" style='float: left;'>
                                        <h2 style='font-size:20px; margin-bottom:10px;'>Lista de cursos</h2>
                                            ...
                                            <?php
                                                ...
                                                while($row = $result->fetch_assoc()) {
                                                    echo "
                                                        ...
                                                        <td>
                                                            <a class='btn btn-primary btn-sm' href='cursosEdit.php?id=$row[id]'>Editar</a>
                                                            <a class='btn btn-danger btn-sm' href='cursosDelete.php?id=$row[id]'>Eliminar</a>
                                                        </td>
                                                        </tr>
                                                    ";
                                                    }
