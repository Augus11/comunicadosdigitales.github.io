...
<?php
    ...
    if( $_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        do {
            $sql = "UPDATE faltas " . 
            "SET fullname = '$fullname', dni = '$dni', dia = '$dia', tipo = '$tipo' " .
            "WHERE id = $id";
    ...
    $query = mysqli_query($con, "INSERT INTO faltas (fullname,dni,dia,tipo) VALUES('".$_POST['fullname']."','".$_POST['dni']."','".$_POST['dia']."','".$_POST['tipo']."')");
            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="faltas.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        ...
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Nombre y Apellido</label>
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="fullname" value="<?php echo $fullname; ?>"></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Fecha</label>
                                                        <input class="form-control" type="date" style="margin-bottom:15px;" name="dia" value="<?php echo $dia; ?>"></input>
                                                        ...
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;" value="<?php echo $tipo; ?>">Tipo de Falta</label>
