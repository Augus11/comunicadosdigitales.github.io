                        ...
                        <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <center>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group" style="  display: flex; flex-direction: row; justify-content: center; align-items: center; width:1400px">
                                                        ...
                                                        <input class="form-control" type="number" style="margin-bottom:15px; margin-left:20px;  margin-right:20px;" name="dni"></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Cuota 1</label>
                                                        <input class="form-control" type="checkbox" style="margin-bottom:15px; margin-left:20px;" name="cuota1"></input>
                                                        
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Cuota 2</label>
                                                        <input class="form-control" type="checkbox" style="margin-bottom:15px; margin-left:20px;" name="cuota2"></input> 
                                                        
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Cuota 3</label>
                                                        <input class="form-control" type="checkbox" style="margin-bottom:15px; margin-left:20px;" name="cuota3"></input> 
                                                        
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Cuota 4</label>
                                                        <input class="form-control" type="checkbox" style="margin-bottom:15px; margin-left:20px;" name="cuota4"></input> 
                                                        
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Cuota 5</label>
                                                        <input class="form-control" type="checkbox" style="margin-bottom:15px; margin-left:20px;" name="cuota5"></input> 
                                                        
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Cuota 6</label>
                                                        <input class="form-control" type="checkbox" style="margin-bottom:15px; margin-left:20px;" name="cuota6"></input> 
                                                    </div>
                                                </p>
                                    ...
                                    <div class="container my-5" style='float: left;'>
                                        <h2 style='font-size:20px; margin-bottom:10px;'>Lista de personas que pagan</h2>

                                        <form action="">
                                            <div class="input-group mb-3">
                                                <input value="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>" type="text" class="form-control" placeholder="Buscar personas" name="search">
                                            ...
                                            <tbody>
                                             ...
                                             <?php
                                                ...
                                                if(isset($_GET['search'])) {
                                                    ...
                                                    $sql = "SELECT * FROM bono WHERE CONCAT(dni) LIKE '%$filtervalues%' ";
                                                    ...
                                                    if(mysqli_num_rows($result) > 0) {
                                                        ...
                                                        while($row3 = $result3->fetch_assoc()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class='btn btn-danger btn-sm' href='bonoDelete.php?id=$row[id]'>Eliminar</a>
                                                                </td>
