...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Evaluaciones - Colegio Preuniversitario Escobar</title>
                                ...
                                <center>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Nombre de la evaluación</label>
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="testname"></input>
                                                    </div>
                                                </p>
                                    ...
                                    <?php
                                        if(isset($_POST['submit'])) {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO tests (nombre) VALUES('".$_POST['testname']."')");	
                                    ...
                                    <div class="container my-5" style='float: left;'>
                                        <h2 style='font-size:20px; margin-bottom:10px;'>Lista de evaluaciones</h2>

                                        <form action="">
                                            <div class="input-group mb-3">
                                                <input value="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>" type="text" class="form-control" placeholder="Buscar Evaluaciones" name="search">
                                        ...
                                        <table class="table">
                                            ...
                                            <?php
                                                if(isset($_GET['search'])) {
                                                    ...
                                                    $sql = "SELECT * FROM tests WHERE CONCAT(nombre) LIKE '%$filtervalues%' ORDER by id ASC ";
                                                ...
                                                if(mysqli_num_rows($result) > 0) {
                                                    ...
                                                    foreach($result as $row){ 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style='font-size:15px;'><?= $row['nombre']; ?></td>
                                                            <td style='font-size:15px;'><?= $row['course']; ?></td>
                                                        <td>
                                                            <?php
                                                            echo "
                                                                <a class='btn btn-primary btn-sm' href='testsEdit.php?id=$row[id]'>Editar</a>
                                                                <a class='btn btn-danger btn-sm' href='testsDelete.php?id=$row[id]'>Eliminar</a>
                                                            ";
                                                            ?>
                                                        </td>
                                                        </tr>
                                                    ...
                                                    $sql = "SELECT * FROM tests ORDER BY id ASC";
