            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: 1000px;">
                        ...
                        <a href="tests.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                            ...
                            <div style="display: flex; align-items: center; ">
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="nombre" value="<?php echo $nombre; ?>"></input>
                                                    </div>
                                                </p>
                                ...
                                <?php
                                    if(isset($_POST['submit'])) {
                                        ...
                                        $query = mysqli_query($con, "INSERT INTO tests (nombre) VALUES('".$_POST['nombre']."')");	
