...
//  print_r($filename_separate);
	...
	if(in_array($file_extension,$extension)) {
		...
		$sql = "INSERT INTO boletines (dni, url) values('$dni', '$image')";
            ...
            <div class="main-content" style=" margin:0 auto;">
                ...
                <div class="row">
                        ...
                        <a href="courseSelect.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                <form action="boletinesUpload.php" method="POST" style="margin:15px;" enctype="multipart/form-data">
                                
                                    <label for="textarea" class="title" style=" font-weight:bold; font-size:15px; margin-bottom:15px;">DNI del alumno</label>
                                    <input class="form-control" type="number" style="margin-bottom:15px;" name="dni" value="<?php echo $dni; ?>" readonly></input>            
                                    
                                    <label for="textarea" class="title" style=" font-weight:bold; font-size:15px; margin-bottom:15px;">Subir PDF del boletín</label>
                                    
                                    <p class="title" style=" font-size:15px; margin-bottom:15px;">Importante: el nombre del archivo no puede ser el mismo a uno ya subido anteriormente.</p>
                                    <input class="form-control" type="file" style="margin-bottom:15px;" name="pdf"></input>
                                    
                                    <input class="btn btn-success" type="submit" style="margin-bottom:15px;" name="submit" value="Subir"></input>  
                                </form>
                        </div>
