                ...
                <div class="row">
                            ...
                            <div class="card card-stats"
                                ...
                                <div style="display:inline; float:left;">
                                    ...
                                    <a href="boletinesUpload.php" class="btn btn-primary" style="width:150px; margin:10px;">Ver boletines</a>
                                </div>


                                <strong style="font-size:20px; font-weight:bold; margin-left:16px; margin-top:16px; ">Subir Boletines:</strong>
                                <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-size: 17px;">Seleccionar curso</h3>
                                <form action="" method="post" class="mb-3">
                                    <div class="select-block">
                                        
                                    <select name="student" class="form-control" style="width: 270px; margin:15px; ">
                                        <?php
                                        require '../connect.php';
                                    ...
                                    if(isset($_POST['submit'])){
                                        if(!empty($_POST['student'])) {
                                                ...
                                                echo "<script> window.location.href='boletines.php?course=$selected' </script>";
                                        }
