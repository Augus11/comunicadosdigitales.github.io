...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Materias - Colegio Preuniversitario Escobar</title>
                                ...
                                <center>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Nombre de la materia</label>
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="subjectName"></input>
                                                    </div>
                                                </p>
                                    ...
                                    <?php
                                        if(isset($_POST['submit'])) {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO materias (nombre) VALUES('".$_POST['subjectName']."')");	
                                    ...
                                    <div class="container my-5" style='float: left;'>
                                        <h2 style='font-size:20px; margin-bottom:10px;'>Lista de materias</h2>
                                            ...
                                            <?php
                                                ...
                                                while($row = $result->fetch_assoc()) {
                                                    echo "
                                                        ...
                                                        <td>
                                                            <a class='btn btn-primary btn-sm' href='materiasEdit.php?id=$row[id]'>Editar</a>
                                                            <a class='btn btn-danger btn-sm' href='materiasDelete.php?id=$row[id]'>Eliminar</a>
                                                        </td>
                                                        </tr>
                                                    ";
                                                    }
