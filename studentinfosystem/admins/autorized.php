...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Autorizados - Colegio Preuniversitario Escobar</title>
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <center>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Nombre y Apelido de la persona</label>
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="pname"></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">DNI de la persona</label>
                                                        <input class="form-control" type="number" style="margin-bottom:15px;" name="pdni"></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">DNI del alumno</label>
                                                        <input class="form-control" type="number" style="margin-bottom:15px;" name="sdni"></input>  
                                                    </div>
                                                </p>

                                                <p>
                                                    <input  type="submit" name="submit" class="btn btn-success" value="Añadir">
                                    ...
                                    <?php
                                        if(isset($_POST['submit'])) {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO autorized (pname,pdni,sdni) VALUES('".$_POST['pname']."','".$_POST['pdni']."','".$_POST['sdni']."')");	
                                ...
                                <div class="container my-5" style='float: left;'>
                                    <h2 style='font-size:20px; margin-bottom:10px;'>Lista de Personas autorizadas a retirar</h2>

                                    <form action="">
                                        <div class="input-group mb-3">
                                            <input value="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>" type="text" class="form-control" placeholder="Buscar Autorizados" name="search">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_GET['search'])) {
                                                    ...
                                                    $sql = "SELECT * FROM autorized WHERE CONCAT(pname,pdni,sdni) LIKE '%$filtervalues%' ";
                                                    ...
                                                    if(mysqli_num_rows($result) > 0) {
                                                        ...
                                                        foreach($result as $row){ 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style='font-size:15px;'><?= $row['pname']; ?></td>
                                                                <td style='font-size:15px;'><?= $row['pdni']; ?></td>
                                                                <td style='font-size:15px;'><?= $row['sdni']; ?></td>
                                                            ...
                                                            <td>
                                                                <?php
                                                                echo "
                                                                    <a class='btn btn-primary btn-sm' href='autorizedEdit.php?id=$row[id]'>Editar</a>
                                                                    <a class='btn btn-danger btn-sm' href='autorizedDelete.php?id=$row[id]'>Eliminar</a>
                                                                ";
                                                                ?>
                                                            </td>
                                                            </tr>
                                                ...
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    $sql3 = "SELECT * FROM students WHERE dni = '".$row['sdni']."'";
