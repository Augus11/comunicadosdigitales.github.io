<?php 
  ...
  if(isset($_POST['register'])) {
    ...
    $query = "SELECT adminName FROM admins WHERE adminName = '$uname'";
    ...
    if(mysqli_num_rows($result) == 0) {
      ...
      if(mysqli_num_rows($result) == 0) {
        ...
        $query = "INSERT INTO admins (adminName, password, firstname, lastname, course, date_joined)
          ...
          <div class="account-info col-sm-6">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label for="adminName">Usuario de Administrador</label>
