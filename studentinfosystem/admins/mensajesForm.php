            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 600px; width: auto;">
                        ...
                        <a href="mensajes.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                <h4 style="font-size: 20px; margin-left:17px;">Responder mensaje</h4>
                                        ...
                                        <form action="" method="post" name="form1" enctype="multipart/form-data">
                                          <center>
                                            ...
                                            <div class="form-group">
                                              <textarea placeholder="Respuesta..." class="form-control" name="comentario" id="textarea" cols="80" rows="5"><?php if(isset($_GET['dni'])) { ?>@<?php echo $_GET['dni']; ?><?php } ?></textarea>
                                            </div>
                                            </p>
                                            ...
                                            <p>
                                              <input  type="submit" <?php if (isset($_GET['id'])) { ?> name="reply"<?php } else { ?>name="submit" <?php } ?> class="btn btn-success" value="Responder">
                                    ...
                                    <?php
                                      if(isset($_SESSION['adminName'], $_SESSION['password'])) {
                                          ...
                                          if(isset($_POST['submit'], $_SESSION['adminName'])) {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO mensajes (mensaje,dni,course,fecha) VALUES('".$_POST['comentario']."','".$_SESSION['adminName']."','".$_POST['course']."',NOW())");	
                                          ...
                                          if(isset($_POST['reply'], $_SESSION['adminName'])) {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO mensajes (mensaje,dni,course,fecha,reply) VALUES('".$_POST['comentario']."','".$_SESSION['adminName']."','".$_POST['course']."',NOW(),'".$_GET['id']."')");	
