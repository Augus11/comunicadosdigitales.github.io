                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="home.php" class="btn btn-primary" style="width: auto; margin:15px; margin-right:5px;">← Volver atras</a>
                                <h4 style="font-size: 20px; margin-left:17px;">Centro de ayuda</h4>
                                    ...
                                    <div>
                                    <a href="uploads/reglamentos/TutorialUBA.pdf" style="margin:15px;">Tutorial de uso</a>
                                    <a href="uploads/reglamentos/REGLAMENTO.pdf" style="margin:15px;">Reglamento</a>     
                                    <a href="uploads/reglamentos/IF-2022.pdf" style="margin:15px;">Anexo II</a>
                                    <a href="uploads/reglamentos/RESCS-2022.pdf" style="margin:15px;">Resolución</a>      
