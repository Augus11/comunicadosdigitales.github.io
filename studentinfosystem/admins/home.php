    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <a href="Boletines/courseSelect.php">
                    <li class="dropdown">
                        <i class="material-icons">domain_verification</i><span>Boletines</span></a>
                    </li>
                </a>
                ...
                <li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="pageSubmenu5">
                        ...
                        <li>
                            <a href="createAccounts.php">Crear Cuentas</a>
                        </li>
                    </ul>
                </li>
                    </ul>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="card card-stats"
                            ...
                            <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-weight: 450; font-size: 20px;">Subir archivos SQL</h3>
                            <a href="sql.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">Subir</a>
                        </div>

                        <div class="card card-stats"
                            style="background-color: rgb(221, 221, 221); width: 300px; height: 150px;">
                            <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-weight: 450; font-size: 20px;">Mensajes</h3>
                            <a href="mensajes.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">Ver todos</a>
                        </div>
                        ...
                        <div class="card card-stats"
                            style="background-color: rgb(221, 221, 221); width: 300px; height: 150px;">
                            <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-size: 20px;">Alumnos</h3>
                            <a href="alumnos.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">Ver todos</a>
                        </div>

                        <div class="card card-stats"
                            style="background-color: rgb(221, 221, 221); width: 300px; height: 150px;">
                            <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-size: 20px;">Materias</h3>
                            <a href="materias.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">Ver todos</a>
                        </div>

                        <div class="card card-stats"
                            style="background-color: rgb(221, 221, 221); width: 300px; height: 150px;">
                            <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-size: 20px;">Cursos</h3>
                            <a href="cursos.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">Ver todos</a>
                        </div>
                        
                        <div class="card card-stats"
                            style="background-color: rgb(221, 221, 221); width: 300px; height: 150px;">
                            <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-size: 20px;">Evaluaciones</h3>
                            <a href="tests.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">Ver todos</a>
                        </div>
                        ...
                        <div class="card-header">
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <div id="container">
                                    <ul id="comments">
                                    <?php  
                                        $comentarios = mysqli_query($con, "SELECT * FROM comentarios WHERE reply = 0 ORDER BY id DESC");
                                        ...
                                        <li class="cmmnt">
                                            ...
                                            <div class="cmmnt-content" style="width:650px;">
                                                <header>
                                                <a href="#" style="font-size:16px;" class="userlink"><?php echo $row['adminName']; ?></a> <span class="pubdate" style="text-transform: lowercase; font-size:16px;">publicó en</span> <a href="#" class="userlink" style="font-size:16px;"><?php echo $row['course']; ?></a> - <span class="pubdate" style="font-size:16px;"><?php echo $row['fecha']; ?></span>
                                                </header>
                                                <p>
                                                ...
                                                <a style="height:30px" class="btn btn-danger" href="Messages/delete-message.php?id=<?php echo $row['id']; ?>">
                                            ...
                                            ?>
                                                ...
                                                <img src="https://www.colegioubaescobar.gob.ar/wp-content/uploads/2020/07/cropped-WhatsApp-Image-2020-02-10-at-11.45.15.jpeg" height="55" width="45">
                                                    ...
                                                    <div class="cmmnt-content">
                                                        <header>
                                                        <a href="#" style="font-size:16px;" class="userlink"><?php echo $rep['adminName']; ?></a> <span class="pubdate" style="text-transform: lowercase; font-size:16px;">respondió</span> - <span class="pubdate" style="font-size:16px;"><?php echo $row['fecha']; ?></span>
                                                        </header>
                                                        <p>
