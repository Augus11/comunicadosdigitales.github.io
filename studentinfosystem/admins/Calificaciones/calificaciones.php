                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                        ...
                                        <h2 style="margin:12px; margin-top:30px; font-size:20px; font-weight:bold;">Calificaciones</h2>
                                                        ...
                                                        echo "
                                                            <tr>
                                                                <form action='uploadMark.php' method='POST'>
                                                                    ...
                                                                    <td style='font-size:15px;'> <input name='selected2[]' readonly id='selected2' class='form-control' type='text' value='$selected2'/></td>
                                                                    <td style='font-size:15px;'> <input name='selected3[]' readonly id='selected3' class='form-control' type='text' value='$selected3'/></td>
                                                                    <td style='font-size:15px;'> <input name='dni[]' readonly id='dni' class='form-control' type='number' value='$row[dni]'/></td>
                                                                    <td style='font-size:15px;'> <input name='firstname[]' readonly id='firstname' class='form-control' type='text' value='$row[firstname]'/>  </td>
                                                                    <td style='font-size:15px;'> <input name='lastname[]' readonly id='lastname' class='form-control' type='text' value='$row[lastname]'/>  </td>
                                                                    <td style='font-size:15px;'> <input name='mark[]' id='mark' required class='form-control' type='text' value=''/>  </td>
                                                            </tr>         
                                                        ";
                                                    }
                                        ?>
