                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="courseSelect.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <div class="container my-5" style='float: left;'>
                                    <h2 style='font-size:20px; margin-bottom:10px;'>Lista de Calificaciones</h2>

                                    <form action="">
                                        <div class="input-group mb-3">
                                            <input value="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>" type="text" class="form-control" placeholder="Buscar Calificaciones" name="search">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_GET['search'])) {
                                                    ...
                                                    $sql = "SELECT * FROM calificaciones WHERE CONCAT(course,firstname,lastname,test,materia,mark) LIKE '%$filtervalues%' ";
                                                    ...
                                                    if(mysqli_num_rows($result) > 0) {
                                                        ...
                                                        foreach($result as $row){ 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style='font-size:15px;'><?= $row['materia']; ?></td>
                                                                <td style='font-size:15px;'><?= $row['test']; ?></td>
                                                                <td style='font-size:15px;'><?= $row['mark']; ?></td>

                                                            <td>
                                                                <?php
                                                                echo "
                                                                    <a class='btn btn-primary btn-sm' href='CalificacionesEdit.php?id=$row[id]'>Editar</a>
                                                                    <a class='btn btn-danger btn-sm' href='CalificacionesDelete.php?id=$row[id]'>Eliminar</a>
                                                                ";
                                                                ?>
                                                            </td>
                                                            </tr>
                                                ...
                                                $sql = "SELECT * FROM calificaciones order by course, materia";
