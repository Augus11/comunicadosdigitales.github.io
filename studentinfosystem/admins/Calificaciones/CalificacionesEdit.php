...
<?php
    ...
    if( $_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        do {
            ...
            "SET firstname = '$firstname', lastname = '$lastname', course = '$course', materia = '$materia', test = '$test', mark = '$mark' " .
            "WHERE id = $id";
    ...
    $query = mysqli_query($con, "INSERT INTO calificaciones (firstname,lastname,course,materia,test,mark) VALUES('".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['course']."','".$_POST['materia']."','".$_POST['test']."','".$_POST['mark']."')");
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Calificaciones - Colegio Preuniversitario Escobar</title>
            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="courseSelect.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        ...
                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Materia</label>
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="materia" value="<?php echo $materia; ?>"></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Evaluación</label>
                                                        <input class="form-control" type="text" style="margin-bottom:15px;" name="test" value="<?php echo $test; ?>" ></input>

                                                        <label for="textarea" class="title" style="font-size:15px; margin-bottom:15px;">Calificación</label>
                                                        <input class="form-control" type="number" style="margin-bottom:15px;" name="mark" value="<?php echo $mark; ?>" ></input>
