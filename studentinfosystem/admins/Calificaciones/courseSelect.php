                ...
                <div class="row">
                            ...
                            <div class="card card-stats"
                                ...
                                <form action="" method="post" class="mb-3">
                                    ...
                                    <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-size: 17px;">Seleccionar materia</h3>

                                    <select name="materias" class="form-control" style="width: 270px; margin:15px; ">
                                        <?php
                                        require '../connect.php';
                                    ...
                                    <h3 style="font-family: 'Roboto', cursive; margin: 15px; font-size: 17px;">Seleccionar evaluación</h3>

                                    <select name="tests" class="form-control" style="width: 270px; margin:15px; ">
                                        <?php
                                        require '../connect.php';
                                        $getCourses1 = "SELECT * FROM tests order by id";
                                        $getCourses2 = mysqli_query($con, $getCourses1);
                                    ...
                                    if(isset($_POST['submit'])){
                                        if(!empty($_POST['courses'])) {
                                            if(!empty($_POST['materias'])) {
                                                ...
                                                $selected2 = $_POST['materias'];
                                                $selected3 = $_POST['tests'];
                                                //echo 'You have chosen: ' . $selected;
                                                echo "<script> window.location.href='calificaciones.php?curso=$selected&materia=$selected2&test=$selected3' </script>";
                                            }
                                    } else {
