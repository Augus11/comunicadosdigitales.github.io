            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="cursos.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <?php
                                    if(isset($_POST['submit'])) {
                                        ...
                                        $query = mysqli_query($con, "INSERT INTO courses (course) VALUES('".$_POST['cursos']."')");	
