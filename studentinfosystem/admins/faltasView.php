                            ...
                            <tbody>
                                <?php
                                        ...
                                        foreach($result as $row) {
                                            ...
                                            $fecha = "SELECT * FROM faltas WHERE curso = '".$selected."' AND dia = '".$selected2."'";
                                            $fechaResult = $con->query($sql);
                                                        ...
                                                        echo "
                                                            <tr>
                                                                <form action='uploadFalta.php' method='POST'>
                                                                    ...
                                                                    foreach($fechaResult as $row5) {
                                                                        echo "<td style='font-size:15px;'> <input name='asistencia[]' readonly id='asistencia' class='form-control' type='text' value='$row5[curso]'/>  </td>
