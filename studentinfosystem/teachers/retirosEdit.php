            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM retiros WHERE id=$id";
                        ...
                        do {
                            $sql = "UPDATE retiros " . 
                            "SET fullname = '$fullname', dni = '$dni', fecha = '$fecha'" . "WHERE id = $id";
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="retiros.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                            ...
                                            <center>
                                                <p>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" style="margin-bottom:15px;" name="fecha" value="<?php echo $fecha; ?>"></input>  
                                                    </div>
                                                </p>
