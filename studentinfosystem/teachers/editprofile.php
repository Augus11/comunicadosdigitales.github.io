<?php 
  ...
  if(isset($_POST['update'])) {
    ...
    $query = "UPDATE admins SET firstname = '$fname', lastname = '$lname', course = '$course'
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                <h4 style="font-size: 20px; margin-left:17px; margin-bottom:20px;">Editar Perfil</h4>
                            ...
                            <section >
                                ...
                                <div class="edit-form box-left clearfix" style="margin-left:18px;">
                                  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">

                                    <div class="form-group">
                                      <label style="font-size:16px; margin-bottom:5px;">Nombre de Usuario</label>
                                      
                                      <?php 
                                        $query = "SELECT teacherName FROM teachers WHERE id = '".$_SESSION['userid']."'";
                                    ...
                                    <div class="form-group">
                                      <label for="firstname" style="font-size:16px; margin-bottom:10px;">Nombre</label>
                                      <input type="text" class="form-control" name="firstname" placeholder="First Name" required>
                                    </div>


                                    <div class="form-group">
                                      <label for="lastname" style="font-size:16px; margin-bottom:10px;">Apellido</label>
                                      <input type="text" class="form-control" name="lastname" placeholder="Last Name" required>
                                    </div>


                                    <div class="form-group">
                                      <label for="course" style="font-size:16px; margin-bottom:10px;">Cursos</label>
                                    ...
                                    <div class="form-footer">
                                      ...
                                      <input class="btn btn-primary" type="submit" name="update" value="Actualizar Perfil" style='margin-bottom:10px;'>
                                    </div>
