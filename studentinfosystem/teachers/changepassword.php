<?php 
  ...
  if(isset($_POST['update'])) {
    ...
    $query = "SELECT password FROM teachers WHERE password = '$oldpass'";
    ...
    if(mysqli_num_rows($result) > 0) {
      ...
      if($newpass == $confirmpass) {
        ...
        $query = "UPDATE teachers SET password = '$newpass' WHERE id='".$_SESSION['userid']."'";

        if($result = mysqli_query($con, $query)) {

          $_SESSION['prompt'] = "Contraseña actualizada.";
        ...
        $_SESSION['errprompt'] = "Las contraseñas no coinciden.";;

      }

    } else {

      $_SESSION['errprompt'] = "Contraseña antigua incorrecta.";
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Cambiar Contraseña - Colegio Preuniversitario Escobar</title>
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                <h4 style="font-size: 20px; margin-left:17px;">Cambiar Contraseña</h4>
                                  ...
                                  <div class="edit-form box-left clearfix">
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                                      ...
                                      <div class="form-group">
                                        <label for="oldpass" style="font-size:16px; margin-bottom:10px;">Contraseña Antigua</label>
                                        <input type="password" class="form-control" name="oldpass" placeholder="Contraseña Antigua" required>
                                      </div>


                                      <div class="form-group">
                                        <label for="newpass" style="font-size:16px; margin-bottom:10px;">Contraseña Nueva</label>
                                        <input type="password" class="form-control" name="newpass" placeholder="Contraseña Nueva" required>
                                      </div>

                                      <div class="form-group">
                                        <label for="confirmpass" style="font-size:16px; margin-bottom:15px;">Confirmar Contraseña</label>
                                        <input type="password" class="form-control" name="confirmpass" placeholder="Confirmar Contraseña" required>
                                      </div>

                                      <div class="form-footer">
                                        <a href="home.php" style='font-size:15px; margin-right:10px;'>Volver</a>
                                        <input class="btn btn-primary" type="submit" name="update" value="Cambiar Contraseña">
                                      </div>
