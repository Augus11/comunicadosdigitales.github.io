                            ...
                            <ul class="nav navbar-nav ml-auto">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card" style="min-height: 485px; width: auto;">
                                                ...
                                                <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                                        <h4 style="font-size: 20px; margin-left:17px;">Personas autorizadas a retirar</h4>
                                            ...
                                            <table class="table">
                                                ...
                                                <?php
                                                    ...
                                                    $query_users = "SELECT * FROM autorized WHERE sdni = '".$_SESSION['dni']."'";
                                    ...
                                    <?php
                                        if(isset($_POST['submit'])) {
                                            ...
                                            $query = mysqli_query($con, "INSERT INTO autorized (pname,pdni,sdni) VALUES('".$_POST['pname']."','".$_POST['pdni']."','".$_SESSION['dni']."')");	
