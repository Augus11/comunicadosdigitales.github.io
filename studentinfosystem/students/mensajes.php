            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <h4 style="font-size: 20px; margin-left:17px;">Comunicarse con preceptoría</h4>
                        ...
                        <center>
                                        ...
                                        <form action="" method="post" name="form1" enctype="multipart/form-data">
                                          <center>
                                            ...
                                            <div class="form-group">
                                              <textarea placeholder="Mensaje..." class="form-control" name="comentario" id="textarea" cols="80" rows="5"><?php if(isset($_GET['dni'])) { ?>@<?php echo $_GET['dni']; ?><?php } ?></textarea>
                                            </div>
                                            </p>
                                            ...
                                            <p>
                                              ...
                                              <a href="mensajes.php" class="btn btn-primary">Cancelar</a>
                                            </p>
                                          </center>
                                        </form>
                                        </div>
                                    ...
                                    <?php
                                      if(isset($_SESSION['dni'], $_SESSION['password'])) {
                                          ...
                                          if(isset($_POST['submit'], $_SESSION['dni'])) {

                                            $query = mysqli_query($con, "INSERT INTO mensajes (mensaje,dni,fullname,course,fecha) VALUES('".$_POST['comentario']."','".$_SESSION['dni']."','".$_SESSION['firstname']." ".$_SESSION['lastname']."','".$_SESSION['course']."',NOW())");	

                                            if($query) {
                                                echo "<script> window.location.href='mensajes.php' </script>";
                                              }
                                              else {
                                ...
                                <h4 style="margin:15px;">Mensajes</h4>

                                <div id="container" style="margin:15px;">
                                    <ul id="comments">
                                    <?php  
                                        $comentarios = mysqli_query($con, "SELECT * FROM mensajes WHERE reply = 0 AND course = '".$_SESSION['course']."' ORDER BY id DESC");
                                        while($row=mysqli_fetch_array($comentarios)) {
                                        $usuario = mysqli_query($con, "SELECT * FROM admins WHERE adminName = '".$row['dni']. "'");
                                        ...
                                        <li class="cmmnt">
                                            ...
                                            <div class="cmmnt-content">
                                                <header>
                                                <span class="pubdate" style="font-size:16px;">preguntaste</span> - <span class="pubdate" style="font-size:16px;"><?php echo $row['fecha']; ?></span>
                                                </header>
                                                <p>
                                            ...
                                            <?php
                                                ...
                                                $usuario2 = mysqli_query($con, "SELECT * FROM admins WHERE id = '".$rep['dni']."'");
                                            ...
                                            ?>
                                                ...
                                                <img src="https://www.colegioubaescobar.gob.ar/wp-content/uploads/2020/07/cropped-WhatsApp-Image-2020-02-10-at-11.45.15.jpeg" height="55" width="45">
                                                    ...
                                                    <div class="cmmnt-content">
                                                        <header>
                                                        <a href="#" class="userlink" style="font-size:16px;">Preceptoría</a> <span class="pubdate" style="text-transform: lowercase; font-size:16px;">respondió</span> - <span class="pubdate" style="font-size:16px;"><?php echo $row['fecha']; ?></span>
                                                        </header>
                                                        <p>
