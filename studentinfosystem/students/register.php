<?php 
  ...
  if(isset($_POST['register'])) {
    ...
    //$studno = clean($_POST['test']); 
    $fname = clean($_POST['firstname']); 
    $lname = clean($_POST['lastname']); 
    $course = clean($_POST['courses']); 
    ...
    //$studno = stripcslashes($studno);
    //$studno = mysqli_real_escape_string($con, $studno);

    $query = "SELECT dni FROM students WHERE dni = '$uname'";
    ...
    if(mysqli_num_rows($result) == 0) {
      ...
      if(mysqli_num_rows($result) == 0) {
        ...
        $query = "INSERT INTO students (dni, password, firstname, lastname, course, date_joined, obs)
        VALUES ('$uname', '$pword', '$fname', '$lname', '$course', NOW(), '$obs')";
        ...
        $_SESSION['errprompt2'] = "El DNI ingresado ya existe.";
        ...
        <div class="row">
          ...
          <div class="personal-info col-sm-6">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="" for="lastname">Observaciones</label>
                <textarea name="obs" class="form-control" id="" cols="42" rows="10"></textarea>
              </div>
