...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Responder - Colegio Preuniversitario Escobar</title>
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <div>
                        <p style='font-size:20px; margin-top:10px; color:white;'>ㅤ</p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 600px; width: auto;">
                        ...
                        <a href="../home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                <h4 style="font-size: 20px; margin-left:17px;">Responder</h4>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <div id="container">
                                  ...
                                  <center>
                                        ...
                                        <form action="" method="post" name="form1">
                                          <center>
                                            ...
                                            <div class="form-group">
                                              <textarea class="form-control" name="comentario" id="textarea" cols="80" rows="5"><?php if(isset($_GET['dni'])) { ?>@<?php echo $_GET['dni']; ?><?php } ?></textarea>
                                            </div>
                                            </p>

                                            <p>
                                              <input  type="submit" name="reply" class="btn btn-success" value="Responder">
                                    ...
                                    <?php
                                      if(isset($_SESSION['dni'], $_SESSION['password'])) {
                                          if(isset($_POST['reply'], $_SESSION['dni'])) {

                                            $query = mysqli_query($con, "INSERT INTO comentarios (comentario,adminName,course,fecha,reply) VALUES('".$_POST['comentario']."','".$_SESSION['dni']."','".$_POST['course']."',NOW(),'".$_GET['id']."')");	
