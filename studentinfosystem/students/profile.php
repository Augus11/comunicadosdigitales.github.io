...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Perfil - Colegio Preuniversitario Escobar</title>
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <a href="logout.php" style='font-size:20px; color:white; margin-left:40px;font-weight:bold;'>Cerrar sesión<span class="glyphicon glyphicon-off" aria-hidden="true"></span></a>
                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                <h4 style="font-size: 20px; margin-left:17px; color:#fff;">Mi Cuenta</h4>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <div id="container">
                                  <?php
                                    ...
                                    $query = "SELECT * FROM students WHERE dni = '".$_SESSION['dni']."' AND password = '".$_SESSION['password']."'";
                                    ...
                                    if($result = mysqli_query($con, $query)) {
                                      ...
                                      echo "<div class='info' style='font-size:15px; MARGIN-BOTTOM:10PX; margin-left:15px;'><strong>DNI:</strong> <span>".$row['dni']."</span></div>";
                                      echo "<div class='info' style='font-size:15px; MARGIN-BOTTOM:10PX; margin-left:15px;'><strong>Nombre:</strong> <span>".$row['lastname'].", ".$row['firstname']."</span></div>";
                                      echo "<div class='info' style='font-size:15px; MARGIN-BOTTOM:10PX; margin-left:15px;'><strong>Curso:</strong> <span>".$row['course']."</span></div>";

                                      $query_ap = "SELECT * FROM apercibimientos WHERE dni = '".$_SESSION['dni']."' ORDER BY id DESC";
                                      $resultAp = mysqli_query($con, $query_ap);

                                      $row2 = mysqli_fetch_assoc($resultAp);

                                      echo "<div class='info' style='font-size:15px; MARGIN-BOTTOM:10PX; margin-left:15px;'><strong>Apercibimientos:</strong> <span>".$row2['total']."</span></div>";

                                      $query_date = "SELECT DATE_FORMAT(date_joined, '%d/%m/%Y') FROM students WHERE id = '".$_SESSION['userid']."'";
                                      $result = mysqli_query($con, $query_date);

                                      $row = mysqli_fetch_row($result);

                                      echo "<div class='info' style='font-size:15px; MARGIN-BOTTOM:10PX; margin-left:15px;'><strong>Fecha de registro:</strong> <span>".$row[0]."</span></div>";

                                    } else {

                                      die("Error en obtener la información de la base de datos.");
