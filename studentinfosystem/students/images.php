                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card" style="min-height: 485px; width: auto;">
                                                ...
                                                <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                                        <h4 style="font-size: 20px; margin-left:17px;">Mis Certificados y Aptos</h4>
                                            ...
                                            <table class="table">
                                                ...
                                                <?php
                                                    ...
                                                    $query_users = "SELECT * FROM images WHERE dni = '".$_SESSION['dni']."'";
                                                    ...
                                                    echo "
                                                        <tr>
                                                            ...
                                                            <td style='font-size:15px;'> <img style='width:100%;' src='$url'/>  </td>
                                                            <td style='font-size:15px;'> <a href='$url' class='btn btn-primary'>Abrir imágen</a> </td>
                                                        <td>
                                                        </td>
                                                        </tr>
