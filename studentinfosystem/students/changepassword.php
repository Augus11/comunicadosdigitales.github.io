  ...
  if(isset($_POST['update'])) {
    ...
    if(mysqli_num_rows($result) > 0) {
      ...
      if($newpass == $confirmpass) {
        ...
        $_SESSION['errprompt2'] = "Las contraseñas no coinciden.";;

      }

    } else {

      $_SESSION['errprompt2'] = "Contraseña antigua incorrecta";
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <a href="logout.php" style='font-size:20px; font-weight:bold; color:white; margin-left:40px;'>Cerrar sesión<span class="glyphicon glyphicon-off" aria-hidden="true"></span></a>
                                  ...
                                  <div class="edit-form box-left clearfix">
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                                      ...
                                      <div class="form-group" style="margin-left:15px;">
                                        <label for="oldpass" style='font-size:15px; margin-bottom:15px;'>Contraseña Antigua</label>
                                        <input type="password" class="form-control" name="oldpass" placeholder="Contraseña Antigua" required>
                                      </div>


                                      <div class="form-group" style="margin-left:15px;">
                                        <label for="newpass" style='font-size:15px; margin-bottom:15px;'>Contraseña Nueva</label>
                                        <input type="password" class="form-control" name="newpass" placeholder="Contraseña Nueva" required>
                                      </div>

                                      <div class="form-group" style="margin-left:15px;">
                                        <label for="confirmpass" style='font-size:15px; margin-bottom:15px;'>Confirmar Contraseña</label>
                                      ...
                                      <div class="form-footer" style="margin-left:15px;">
                                        <a href="home.php"  style='font-size:15px;'>Volver</a>
