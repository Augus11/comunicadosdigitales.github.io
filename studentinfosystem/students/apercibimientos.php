                ...
                <div class="row">
                    ...
                    <div class="card" style="min-height: 485px; width: auto;">
                        ...
                        <a href="home.php" class="btn btn-primary" style="width: 270px; margin:15px; margin-right:5px;">← Volver atras</a>
                                <h4 style="font-size: 20px; margin-left:17px;">Apercibimientos</h4>
                            ...
                            <div style="display: flex; align-items: center; ">
                                ...
                                <div id="container">
                                    <?php
                                        ...
                                        $query = "SELECT * FROM apercibimientos WHERE dni = '".$_SESSION['dni']."' ORDER BY total DESC";
                                    ...
                                    <ul> 
                                        <li class="" style="height: 100px; background-color: #ebebeb; border-radius:10px;">
                                            <div style="margin:15px; margin-bottom:15px;">
                                                <div style="display: flex; font-size:15px; margin-bottom:10px;" >
                                                        <h6 style="font-weight:600; margin-top:15px;" >Apercibimiento N°<?php echo $row['total']; ?> ㅤㅤ</h6> <h6  style="font-weight:600; margin-top:15px;">Fecha: <?php echo $row['fecha']; ?></h6>
                                                </div>
                                                <div style="font-size:15px; display: flex;">
                                                        <h6 style="font-weight:600;">Razón:<h6 style="margin-left:10px;"><?php echo $row['reason'];?> </h6> </h6>
                                                </div>
                                            </div>
