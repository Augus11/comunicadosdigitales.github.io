    ...
    ?>
      ...
      <form class="navbar-form navbar-right" action="searchresults.php" method="GET">
        ...
        <div class="search-area">
          ...
          <input type="submit" name="search" id="search-btn" value="Contactanos" class="btn btn-default">

        </div>
        
        <div class="welcome"><?php echo "Bienvenido, <a href='profile.php'>".$_SESSION['dni']."</a>!";?></div>

        <a href="logout.php">Cerrar sesión<span class="glyphicon glyphicon-off" aria-hidden="true"></span></a>
