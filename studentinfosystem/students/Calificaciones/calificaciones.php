        ...
        <div id="content">
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <a href="../logout.php" style='font-size:18px; font-weight:bold; color:white; margin-left:2px;'>Cerrar sesión<span class="glyphicon glyphicon-off" aria-hidden="true"></span></a>
            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <h2 style='font-size:20px; margin-bottom:10px;'>Mis Calificaciones</h2>
                    <br>
                    <table class="table">
                        <thead>
                        <tr>
                        ...
                        <?php
                            ...
                            $query_users = "SELECT * FROM calificaciones WHERE dni = '".$_SESSION['dni']."' ORDER BY materia ASC";
